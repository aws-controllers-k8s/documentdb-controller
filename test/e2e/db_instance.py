...
def wait_until(
    ...
    """Waits until a DB instance with a supplied ID is returned from the DocDB API
...
def get(db_instance_id):
    """Returns a dict containing the DB instance record from the DocDB API.
...
def get_tags(db_instance_arn):
    """Returns a dict containing the DB instance's tag records from the DocDB API.
